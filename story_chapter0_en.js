...
(function(global){
  ...
  global.PZ_CHAPTER0_STAGES_EN = [
    ...
    {name:"Consciousness Collapse", desc:"During the escape, both of them suddenly collapse as their minds are pulled somewhere unknown."},
    {name:"Endscape", desc:"Hermit wakes in a ruined world and realizes Kane is gone."},
    {name:"Crystal Man", desc:"A crystalized human figure appears before Hermit, forcing a fight."},
    {name:"Different Worlds", desc:"Hermit finds Kane again, but each of them is seeing a completely different world."},
    ...
    {name:"Middle Layer", desc:"They reach the middle layer of the Daydream, where massive crystals begin giving birth to monsters."},
  ...
  global.PZ_CHAPTER0_STORY_EN = {
    ...
    3: [
      ...
      ["System","Objective: hold on before consciousness breaks."]
    ],
    4: [
    ...
    6: [
      ...
      ["{playerName}","I saw it."],
      ["System","Objective: continue moving deeper into the Daydream."]
    ],
    7: [
