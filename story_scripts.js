...
(function(global){
  ...
  global.PZ_STORY_SCRIPTS = {
    tutorial_intro: [
      ...
      { speaker:{zh:"旁白", en:"Narrator"}, text:{zh:"主角接过许可。就在这时，外面突然传来巨响。", en:"The protagonist takes the permit. At that moment, a heavy blast erupts outside."}, bg:"office" },
      ...
      { speaker:{zh:"旁白", en:"Narrator"}, text:{zh:"人群开始逃跑。守卫冲出事务处。主角低头看了一眼刚拿到的许可。", en:"The crowd flees. Guards rush out of the Affairs Office. The protagonist looks down at the newly issued permit."}, bg:"office" },
      { speaker:{zh:"旁白", en:"Narrator"}, text:{zh:"主角没有说话，直接冲向怪物。", en:"Without a word, the protagonist runs toward the monsters."}, bg:"office" },
    ...
    tutorial_after_battle: [
      ...
      { speaker:{zh:"旁白", en:"Narrator"}, text:{zh:"主角沉默。", en:"The protagonist remains silent."}, bg:"after" },
      { speaker:{zh:"旁白", en:"Narrator"}, text:{zh:"对方看了一眼主角手中的战斗许可。", en:"The person glances at the combat permit in the protagonist's hand."}, bg:"after" },
